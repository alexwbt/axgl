...
class RenderCube : public axgl::interface::Service
{
public:
  std::shared_ptr<axgl::interface::Realm> realm;
  ...
  void initialize() override
  {
    ...
    // realm
    realm = axgl->realm_service()->create_realm();
    ...
    // camera
    realm->camera.position.z = -10;
  }

  void update() override
  {
    realm->camera.yaw += 0.1f;
    realm->camera.update();
  }
};
...
int main()
{
  ...
  axgl.register_service("main", std::make_shared<RenderCube>());
  axgl.run();
}
