...
class ElementContainer : virtual public Container<axgl::gui::Element>
{
  ...
  std::vector<std::shared_ptr<axgl::gui::Element>> elements_;
...
public:
  ...
  void add(std::shared_ptr<axgl::gui::Element> element) override
  {
    element->set_parent(parent_);
    elements_.push_back(std::move(element));
  }

  void remove(const std::shared_ptr<axgl::gui::Element>& element) override { std::erase(elements_, element); }

  [[nodiscard]] util::Iterable<std::shared_ptr<axgl::gui::Element>> get() const override
  {
    return util::to_iterable_t<std::shared_ptr<axgl::gui::Element>>(elements_);
  }
};
