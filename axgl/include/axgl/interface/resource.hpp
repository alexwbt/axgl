...
{
public:
  virtual void load_resources(const std::string& path) = 0;
  ...
  virtual void load_resource_from_mem(const std::string& key, std::span<const uint8_t> data) = 0;
  virtual void load_resources_from_mem(const std::string& key_prefix,
